...
public class KennsluskraController {
    ...
    // Viðmótshlutir
    @FXML
    private ListView<Namskeid> fxListiNamskeid;
    @FXML
    ...
    public void initialize() {
        ...
        fxListiNamskeid.setItems(kennsluskra.getOllNamskeid()); // tengja listann við viðmótið
        // gera hnappa óvirka ef ekkert er valið
        fxEyda.disableProperty().bind(
                fxListiNamskeid.getSelectionModel().selectedItemProperty().isNull());
    ...
    private void eydaNamskeidiHandler(ActionEvent ignored) {
        kennsluskra.eydaNamskeidi(fxListiNamskeid.getSelectionModel().getSelectedIndex());
    }
    ...
    private void skodaNamskeidHandler(ActionEvent ignored) {
        skodaNamskeid(fxListiNamskeid.getSelectionModel().getSelectedIndex());
    }
