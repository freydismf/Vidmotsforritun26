package is.vidmot;
/**
 * Sýnidæmi - einfalt sýnidæmi um stýringu fyrir að skipta á milli leikmanna
 *
 */
...
public class Controller  {
    ...
    // aðrar stýringar, einn controller fyrir leikmanninn og
    // annar fyrir mótherjann
    ...
    public void skiptaMotherja(ActionEvent actionEvent) {
        // náum í núverandi glugga, einn og sami glugginn
